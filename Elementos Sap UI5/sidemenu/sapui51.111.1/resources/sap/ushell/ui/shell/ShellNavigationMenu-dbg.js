    ...
    var ShellNavigationMenu = Control.extend("sap.ushell.ui.shell.ShellNavigationMenu", {
        ...
        renderer: {
            ...
            render: function (oRm, oControl) {
                ...
                oTitle.setDescription(oControl.getDescription());
                oRm.openStart("div");
                oRm.attr("id", "sapUshellNavTitle");
                oRm.openEnd();
    ...
    */
    ShellNavigationMenu.prototype._beforeOpen = function () {
        ...
        if (!this.bInitialized) {
            ...
            this.oTitle = new StandardListItem("navMenuInnerTitle", {
                wrapping: true
            }).addStyleClass("sapUshellNavigationMenuTitleItem");
    ...
    ShellNavigationMenu.prototype.onAfterRendering = function () {
        ...
        // The AccessibilityCustomData writeToDom hack does not work with rendering API 2 - tabindex is not set
        // Do it explicitly
        if (Device.system.desktop) {
            jqInnerTitle.attr("tabindex", "0");
        }
