    ...
    var SessionHandler = function (AppLifeCycle) {
        ...
        this.monitorUserIsInactive = function () {
            ...
            var iTimeLastInteraction = this.timeLastInteraction(),
                ...
                iRemainingTimeUntilDialog = iTimePopup - iTimeNow,
                iTimeSinceLastInteraction = iTimeNow - iTimeLastInteraction,
                oMonitorUserIsInactiveTimer;
            ...
            if (iTimeNow < iTimePopup) {
                oMonitorUserIsInactiveTimer = setTimeout(this.monitorUserIsInactive.bind(this), iRemainingTimeUntilDialog * 1000);
        ...
        this.continueWorkingFormatter = function (iSessionRemainingTimeInSeconds) {
            ...
            sTimeUnit = bIsTimeInMinutes ? oResources.i18n.getText("sessionTimeoutMessage_units_minutes") : oResources.i18n.getText("sessionTimeoutMessage_units_seconds");
