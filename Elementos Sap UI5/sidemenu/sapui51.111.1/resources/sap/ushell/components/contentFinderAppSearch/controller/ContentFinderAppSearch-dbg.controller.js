    ...
    /** @lends sap.ushell.components.ContentFinderAppSearch.controller.ContentFinderAppSearch.prototype */ {
            ...
            */
            ...
            _tileAppBoxFactory: function (sId, oContext) {
                ...
                oAppBox.setLaunchUrl(oContext.getProperty("launchUrl"));
                oAppBox.setTitle(oContext.getProperty("title"));
                oAppBox.setSubtitle(oContext.getProperty("subtitle"));
                oAppBox.setInfo(oContext.getProperty("info"));
                oAppBox.setSystemInfo(oContext.getProperty("systemInfo"));
