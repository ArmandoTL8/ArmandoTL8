...
sap.ui.define([
    ...
    var GenericTileScope = sapMLibrary.GenericTileScope;
    var GenericTileMode = sapMLibrary.GenericTileMode;
    ...
    return Controller.extend(COMPONENT_NAME, {
        ...
        onCancelConfiguration: function (oConfigurationView/*, successHandler, errorHandle*/) {
            ...
            var oViewData = oConfigurationView.getViewData(),
                ...
                oTileModel = oModel.getProperty("/tileModel"),
                oTileApi = oViewData.chip,
                oCurrentConfig = utils.getAppLauncherConfig(oTileApi, false, false);
        ...
        loadData: function () {
            ...
            if (!this.oDataRequest || this.oDataRequest.sUrl !== sUrl) {
                ...
                this.oDataRequest = new DynamicTileRequest(sUrl, this.successHandlerFn.bind(this), this.errorHandlerFn.bind(this));
