...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.components.shell.Settings.appearance.Appearance", {
        ...
        /**
         * Complete save method of the properties of the appearance tab
         * Includes
         * - preparing each property
         * - save with the given function
         * - post processing of save with error handling
         *
         * @param {Function} fnUpdateUserPreferences function used to update properties
         * @returns {Promise} Promise that, resolves if no error occurs
         *                                  rejects with error messages
         */
                ...
                return new Promise(function (resolve, reject) {
                    this.writeToPersonalization("flp.settings.FlpSettings", "sizeBehavior", sNewSizeBehavior)
                        ...
                        .fail(function (sErrorMessage, parsedErrorInformation) {
                            Log.error("Can not save tile size configuration", sErrorMessage);
