...
sap.ui.define([
    ...
    function AppConfiguration () {
         ...
         * @deprecated since 1.48. Please use {@link #getSettingsControlAsync} instead.
         * @private
         */
        this.getSettingsControl = function () {
            var sSettingButtonPath = "sap/ushell/ui/footerbar/SettingsButton",
                SettingsControlConstructor = sap.ui.require(sSettingButtonPath);

            if (SettingsControlConstructor) {
                return new SettingsControlConstructor();
            }

            Log.warning("sap.ushell.services.AppConfiguration.getSettingsControl is deprecated. Use getSettingsControlAsync instead.");
            Log.error("sap.ushell.services.AppConfiguration.getSettingsControl: sap.ushell.ui.footerbar.SettingsButton must be loaded before use.");
            return undefined;
        };
