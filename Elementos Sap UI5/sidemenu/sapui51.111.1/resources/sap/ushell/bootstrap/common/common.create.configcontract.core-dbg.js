        ...
        var oConfigDefinition = {
            core: { // the unified shell core
                ...
                shell: {
                    ...
                    // switch to toggle About button in UserActionsMenu
                ...
                customPreload: {
                    // only expose enabled flag and coreResourcesComplement to higher-level consumers
                    // coreResources should only be relevant for the bootstrap
                    // always disable when debug mode is on
