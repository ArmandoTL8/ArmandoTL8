import type { DataFieldAbstractTypes, DataFieldForAnnotationTypes, FieldGroup } from "@sap-ux/vocabularies-types/vocabularies/UI";
...
export function isAnnotationFieldStaticallyHidden(annotationProperty: DataFieldForAnnotationTypes) {
