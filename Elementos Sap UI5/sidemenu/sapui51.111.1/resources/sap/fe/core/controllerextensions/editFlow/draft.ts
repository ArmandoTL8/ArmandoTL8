 ...
 * @ui5-restricted
 */
function showEditConfirmationMessageBox(sUnsavedChangesMsg: string, oContext: V4Context) {
 ...
 * @ui5-restricted
 */
function deleteDraft(oContext: V4Context, oAppComponent?: AppComponent, bEnableStrictHandling?: boolean): Promise<boolean> {
