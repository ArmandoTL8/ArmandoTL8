	...
	ExplodeToolGizmo.prototype.init = function() {
		...
		function createGizmoArrow(arrowLength, dir, color, touchAreas) {
			...
			if (touchAreas) {
				...
				var mergedGeometry = THREE.BufferGeometryUtils.mergeBufferGeometries([touchGeometry, touchGeometry2]);
		...
		var dconeHeight = 16;
		var doubleCone = THREE.BufferGeometryUtils.mergeBufferGeometries([
