...
sap.ui.define([
	...
	var DateTimeUtil = {
		...
		localToUiTimezone: function(oDate) {
			var oUiTimezoneDate = new Date(oDate.toLocaleString('en-US', {
				timeZone: UI_TIMEZONE
			}));

			var iDiff = oDate.getTime() - oUiTimezoneDate.getTime();

			return new Date(oDate.getTime() - iDiff);
		},
		...
		uiTimezoneToUtc: function(oDate) {
			var oUtcDate = new Date(oDate.toLocaleString('en-US', {
				timeZone: "UTC"
			}));
			var oInvdate = new Date(oDate.toLocaleString('en-US', {
				timeZone: UI_TIMEZONE
			}));
		...
		localToTimezone: function(oDate, sTimezone) {
			...
			var oTimezoneDate = new Date(oDate.toLocaleString('en-US', {
				timeZone: sTimezone
			}));
			var oUiTimezoneDate = new Date(oDate.toLocaleString('en-US', {
				timeZone: UI_TIMEZONE
