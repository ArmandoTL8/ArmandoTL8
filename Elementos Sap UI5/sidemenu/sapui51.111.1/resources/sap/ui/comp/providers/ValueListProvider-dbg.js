...
sap.ui.define([
	...
	var ValueListProvider = BaseValueListProvider.extend("sap.ui.comp.providers.ValueListProvider", {
		constructor: function(mParams) {
			if (mParams) {
				...
				this._bSuggestionsEnabled = true;
			}
	...
	ValueListProvider.prototype._createDropDownTemplate = function() {
		var sDDLBDisplayBehaviour = this.sValueListsDDLBDisplayBehaviour || this.sDDLBDisplayBehaviour;

		if (this.oControl.isA("sap.ui.comp.smartfield.ComboBox") &&
			this.sValueListsDDLBDisplayBehaviour &&
			this.sValueListsDDLBDisplayBehaviour !== this.sDDLBDisplayBehaviour) {
			this.oControl.setValueTextArrangement(this.sDDLBDisplayBehaviour);
		}
	...
	ValueListProvider.prototype._setupHistoryValues = function () {
		...
		this._oHistoryValuesProvider.getSuggestionsEnabled().then(function (bEnabled) {
			this._bSuggestionsEnabled = bEnabled;
		}.bind(this));
	};
