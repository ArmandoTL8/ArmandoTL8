...
sap.ui.define([
	...
	HistoryValuesProvider.prototype.attachChangeListener = function () {
		...
		if (this._oControl.isA("sap.m.Input")) {
			this._oControl.attachSuggestionItemSelected(this._onInputSuggestionItemSelected, this);
			return;
		}
	...
	HistoryValuesProvider.prototype._detachChangeListener = function () {
		...
		if (this._oControl.isA("sap.m.Input")) {
			this._oControl.detachSuggestionItemSelected(this._onInputSuggestionItemSelected, this);
			return;
		}
	...
	HistoryValuesProvider.prototype._onInputSuggestionItemSelected = function (oEvent) {
	...
	HistoryValuesProvider.prototype.getSuggestionsEnabled = function () {
		return this._getHistoryGlobalDataService().getSuggestionsEnabled();
	};
