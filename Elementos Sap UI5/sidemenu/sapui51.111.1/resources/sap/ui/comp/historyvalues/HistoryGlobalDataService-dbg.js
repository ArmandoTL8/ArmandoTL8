...
sap.ui.define([
	...
	HistoryGlobalDataService.prototype._initializeHistoryData = function (oData) {
		...
		this._oData = Object.assign({ suggestionsEnabled: true }, this._oData);
	...
	HistoryGlobalDataService.prototype.getSuggestionsEnabled = function () {
		return this._isDataReady().then(function () {
			return true;
		}/*.bind(this)*/);
	};

	HistoryGlobalDataService.prototype.setSuggestionsEnabled = function (bEnabled) {
		return this._isDataReady().then(function () {
			this._oData.suggestionsEnabled = bEnabled;
