sap.ui.define([
	...
	LocaleData, Constants, DatePicker , DateTimePicker , TimePicker, Dialog, Button, AutoSuggestionFixedValuePanelRenderer) {
	"use strict";
	...
	var autoSuggestionFixedValuePanel = Control.extend("sap.rules.ui.ast.autoCompleteContent.AutoSuggestionFixedValuePanel", {
		...
		_createLayout: function (vocabularyInfo) {
			...
			this.fixedValueTextArea = new sap.m.Input({
				...
				showSuggestion: true,
				autocomplete: false,
				ariaLabelledBy: this._invisibleText.getId(),
			...
			var fixedValuePanel = new sap.m.Panel({
				...
				expandable: true,
				expanded: false,
				content: [this._invisibleText, this.fixedValueTextArea],
				width: "auto"
			})
