...
sap.ui.define([
    ...
    function (jQuery, library, Control, SimpleForm, Label, Switch, Select, MessageBox, Table, Text, CheckBox, Input, Button,
        ExpressionAdvanced, VerticalLayout, ExpressionType, Constants, AstExpressionBasic, AstExpressionLanguage, AstUtil, DecisionTableSettingsRenderer) {
        "use strict";
        ...
        sap.rules.ui.DecisionTableSettings.prototype._getAttributeSequenceArray = function () {
            var attributeSequenceArray = this.getModel("settingsModel").attributeSequenceArray;
        ...
        sap.rules.ui.DecisionTableSettings.prototype._getOrderedAttributesArray = function (dataAttrList) {
            var attributeSequenceArray = this.getModel("settingsModel").attributeSequenceArray;
        ...
        sap.rules.ui.DecisionTableSettings.prototype._moveAttributePosition = function (oContext, sDirection) {
            var settingsModel = this.getModel("settingsModel");
            var settingsData = settingsModel.getData();
        ...
        sap.rules.ui.DecisionTableSettings.prototype._formatAttributeId = function (attributeId) {
        ...
        sap.rules.ui.DecisionTableSettings.prototype._applySettingsModelChangesToOData = function (oDialog) {
            ...
            var submitSuccess = function (batchRequestResponse) {
                ...
                if (!foundErrorInBatch) {
                    sap.m.MessageToast.show(that.oBundle.getText("settingsApplySuccess"));
                }
            ...
            if (bRefreshed && this.attributeListEmpty) {
                ...
                sap.ui.core.BusyIndicator.hide();
                oDialog.close();
                sap.m.MessageToast.show(this.oBundle.getText("settingsApplySuccess"));
                return;
            }
