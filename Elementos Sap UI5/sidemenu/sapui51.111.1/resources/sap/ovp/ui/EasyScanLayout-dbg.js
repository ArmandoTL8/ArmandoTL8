sap.ui.define([
    ...
    ReplaceItems.prototype.initCardsSettingsForDragAndDrop = function () {
        ...
        this.isRTLEnabled = Core.getConfiguration().getRTL() ? 1 : -1;
        this.aCardsOrder = [];
    ...
    ReplaceItems.prototype.updateElementCSS = function (element) {
        jUtils.addStyleToAllElements(element, "top", element.posDnD.top);
        jUtils.addStyleToAllElements(element, "left", element.posDnD.left);
    };
    ...
    KeyboardNavigation.prototype.init = function (easyScanLayout, swapItemFunction) {
        ...
        document.querySelector("body").addEventListener("keyup", this.bodyKeyupHandler.bind(this));
        document.querySelector("body").addEventListener("keydown", this.bodyKeydownHandler.bind(this));
    ...
    KeyboardNavigation.prototype.layoutItemFocusHandler = function () {
        ...
        if (jqFocused) {
            ...
            // Fix - for extended bar list - comparison micro chart being read multiple times. 
            var bNotExtendedBarListCard = jqFocused.find(".sapOvpExtendedBarListHBox").length === 0;
            if (isNotStackCardHeader && bNotExtendedBarListCard) {
    ...
    */
    ...
    KeyboardNavigation.prototype.spacebarHandler = function (e) {
        ...
        var item = Core.byId(e.target.id);
    ...
    var EasyScanLayout = Control.extend("sap.ovp.ui.EasyScanLayout", {
        ...
        renderer: {
            render: function (oRm, oControl) {
                var aCards = Core.getComponent(oControl._sOwnerId) && Core.getComponent(oControl._sOwnerId).oOvpConfig.cards;
    ...
    EasyScanLayout.prototype.init = function () {
        ...
        if (Core.getComponent(this._sOwnerId) && Core.getComponent(this._sOwnerId).oOvpConfig.cards.length === 0) {
    ...
    EasyScanLayout.prototype.afterDragAndDropHandler = function (aElements) {
        ...
        aElements.forEach(function (el, index) {
            ...
            var oControl = Core.byId(elementId);
