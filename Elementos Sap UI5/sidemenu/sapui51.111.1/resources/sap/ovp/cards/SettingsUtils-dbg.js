        ...
        if (sap.ushell && sap.ushell.Container) {
            sap.ushell.Container.getService("CrossApplicationNavigation")
                ...
                .done(function (aLinks) {
                    ...
                    sap.ushell.Container.getService("CrossApplicationNavigation")
                        .isIntentSupported(aAllIntents)
                        .done(function (oResponse) {
                            // Setting the model of Dialog Form with Semantic Objects and Actions
                            var aLinks = [];
                            for (var key in oResponse) {
                                if (
                                    oResponse.hasOwnProperty(key) &&
                                    oResponse[key].supported === true &&
                                    oLinkToTextMapping &&
                                    oLinkToTextMapping[key]
                                ) {
        ...
        getDialogBox: function (oComponentContainer) {
            return new Promise(
                function (resolve, reject) {
                    ...
                    if (oCardProperties.layoutDetail === "resizable") {
                        ...
                        if (!oCardProperties.defaultSpan) {
                            ...
                            oCardPropertiesModel.setProperty(
                                "/defaultSpan/rows",
                                supportedCards.indexOf(oCardProperties.template)
                    ...
                    // settings view
                    var oSettingsView = new XMLView("settingsView", {
