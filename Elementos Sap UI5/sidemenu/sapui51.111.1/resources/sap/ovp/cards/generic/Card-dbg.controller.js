sap.ui.define([
    ...
    return Controller.extend("sap.ovp.cards.generic.Card", {
        ...
        onInit: function () {
            ...
            this.oCardComponentData =
                this.oCardComponent && this.oCardComponent.getComponentData();
            this.oMainComponent =
                this.oCardComponentData && this.oCardComponentData.mainComponent;
        ...
        onAfterRendering: function () {
            ...
            if (oCardHeaderDomRef && !oCardHeaderDomRef.getAttribute("ariaLabelledBy")) {
                if (oHeaderTitle && oHeaderTitle.getText()) {
                    ...
                    oQuickViewCardHeaderEnabled &&
                    oQuickViewCardHeaderEnabled.getText()
                ) {
            ...
            if (
                ...
                var $wrapper = jQuery(
                    "#" + this.oDashboardLayoutUtil.getCardDomId(this.cardId)
                );
            ...
            if (sContentFragment === "sap.ovp.cards.stack.Stack") {
                ...
                var cardContentContainer =
                    oCardRef && oCardRef.querySelector(".sapOvpCardContentContainer");
            ...
            if (bIsNavigable) {
                ...
                if (
                    ...
                    if (sContentFragment === "sap.ovp.cards.stack.Stack") {
                        var oCardRef = this.getView().getDomRef();
                        var stackContainer = oCardRef.querySelectorAll(
            ...
            if (oEntityType) {
                if (oCardPropsModel) {
                 ...
                 When more than one IdentificationAnnotationPath exists, they need to be split and assigned accordingly to Stack and Quickview Cards */
                    ...
                    if (
                        oCardPropsModel &&
                        oCardPropsModel.getProperty("/template") ===
                        "sap.ovp.cards.charts.analytical"
                    ) {
                        var sKpiAnnotationPath =
                            oCardPropsModel.getProperty("/kpiAnnotationPath");
                        if (oEntityType && sKpiAnnotationPath) {
                            var oRecord = oEntityType[sKpiAnnotationPath];
                            if (oRecord && oRecord.Detail) {
                                var sSemanticObject =
                                    oRecord.Detail.SemanticObject &&
                                    oRecord.Detail.SemanticObject.String;
                                var sAction =
                                    oRecord.Detail.Action && oRecord.Detail.Action.String;
                ...
                oCardPropsModel &&
                oCardPropsModel.getProperty("/template") === "sap.ovp.cards.linklist" &&
        ...
        checkAPINavigation: function () {
            var oComponentData = this.getOwnerComponent().getComponentData(),
                bCheckIfValidArg =
                    oComponentData.fnCheckNavigation &&
        ...
        */
                    ...
                    oKPIBinding.attachDataReceived(
                        function (oEvent) {
                            ...
                            if (kpiHeader[0]) {
                                ...
                                if (iTotal === 0) {
                                    this._setSubTitleWithUnitOfMeasure(UoM, false);
                                    kpiHeader[0].style.visibility = "hidden";
                                } else {
                                    this._setSubTitleWithUnitOfMeasure(UoM, true);
         ...
         */
        _setSubTitleWithUnitOfMeasure: function (UoM, bHasData) {
            var oCardPropertiesModel = this.getCardPropertiesModel();
        ...
        doNavigation: function (oContext, oNavigationField, sNavMode) {
            ...
            if (!this.oMainComponent.oAppStatePromise) {
                ...
                this.oMainComponent.oAppStatePromise.then(
                ...
                .done(function (oResponse) {
                    if (oResponse[sIntent].supported === true) {
                        ...
                        */
                        ...
                        oGlobalFilter = that._removeFilterFromGlobalFilters(
                            mFilterPreference,
                            oGlobalFilter
                        );
            ...
            if (oNavigationHandler) {
                if (oIntent) {
                    ...
                    if (oParameters.sNavPresentationVariant) {
                        oAppExternalData.presentationVariant =
                            oParameters.sNavPresentationVariant;
                    }
             ...
             */
                if (!this.oCardComponentData.settings.identificationAnnotationPath) {
                    ...
                    if (kpiAnnotationPath && sCardType === "sap.ovp.cards.charts.analytical") {
                        ...
                        var sSemanticObject =
                            oDetail.SemanticObject && oDetail.SemanticObject.String;
            ...
            if (Array.isArray(aRecords)) {
                ...
                for (var i = 0; i < aRecords.length; i++) {
                    ...
                    if (aRecords[i].RecordType === "com.sap.vocabularies.UI.v1.DataFieldWithUrl" && !aRecords[i].Url.UrlRef) {
                        ...
                        var oEntityBindingContext = oMetaData.createBindingContext(
                            oEntityType.$path
                        );
                        var sBindingString = OdataAnnotationHelper.format(
                            oEntityBindingContext,
                            aRecords[i].Url
                        );
        ...
        getEntitySet: function () {
            if (!this.entitySet) {
                ...
                this.entitySet =
                    this.getMetaModel().getODataEntitySet &&
                    this.getMetaModel().getODataEntitySet(sEntitySet);
            }
        ...
        _processCustomParameters: function (oContextData, oSelectionData, oContextParameters) {
            ...
            for (i = 0; i < iLength; i++) {
                ...
                if (!sPath || typeof sPath !== "string" || sPath === "") {
                    oLogger.error(
                        "Custom Variant property path '" + sPath + "' should be valid string"
                    );
                    continue;
                }
        ...
        _getEntityNavigationParameters: function (oEntity, oCustomParameters, oContext) {
            ...
            var oCardPropertiesModel = this.getCardPropertiesModel();
            var oStaticLinkList =
                oCardPropertiesModel && oCardPropertiesModel.getProperty("/staticContent");
            if (!oStaticLinkList) {
                ...
                if (oStaticLinkList[oCustomParameters.iStaticLinkListIndex].params) {
                    ...
                    oStaticLinkList[oCustomParameters.iStaticLinkListIndex].staticParameters
                ) {
            ...
            if (!oStaticLinkList) {
                this._removeSensitiveAttributesFromNavSelectionVariant(
                    oEntityType,
                    oNavSelectionVariant
                );
            }

            return {
                sNavSelectionVariant: oNavSelectionVariant
                    ? oNavSelectionVariant.toJSONString()
                    : null,
                sNavPresentationVariant: oPresentationVariant
                    ? oPresentationVariant.toJSONString()
                    : null
            };
        },

        _removeSensitiveAttributesFromNavSelectionVariant: function (
            oEntityType,
            oNavSelectionVariant
        ) {
        ...
        _getFilterPreference: function () {
            var oCompData = this.getOwnerComponent()
                ? this.getOwnerComponent().getComponentData()
                : null;
            var mFilterPreference;
            if (oCompData && oCompData.mainComponent) {
                mFilterPreference = oCompData.mainComponent._getFilterPreference(
                    oCompData.cardId
                );
            }
        ...
        _buildSelectionVariant: function (oGlobalFilter, oCardSelections) {
            ...
            var mFilterPreference = this._getFilterPreference();
            oSelectionVariant = this._removeFilterFromGlobalFilters(
                mFilterPreference,
                oSelectionVariant
            );
        ...
        checkIBNNavigationExistsForCard: function() {
            ...
            if (oCardPropsModel && oEntityType && sContentFragment) {
                ...
                if (sContentFragment === "sap.ovp.cards.list.List" || sContentFragment === "sap.ovp.cards.table.Table") {
                ...
                if (sContentFragment === "sap.ovp.cards.charts.analytical.analyticalChart") {
