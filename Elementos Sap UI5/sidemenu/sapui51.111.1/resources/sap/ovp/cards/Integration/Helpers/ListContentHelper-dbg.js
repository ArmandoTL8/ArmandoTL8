sap.ui.define([ "sap/ovp/cards/Integration/Helpers/ContentHelper"], function (ContentHelper) {
    "use strict";
    ...
    function _getMinMaxFormatter(sPath, sType) {
        return "{= extension.formatters.getMinMax('" + sPath + "', '" + sType + "', $" + ContentHelper.addBrackets(sPath) + ")}";
    }
    ...
    function _getChart(oCardDefinition) {
        ...
        oChart.minValue = isThresholdPercentage ? 0 : _getMinMaxFormatter(sChartValue, "min");
        oChart.maxValue = isThresholdPercentage ? 100 : _getMinMaxFormatter(sChartValue, "max");
        return oChart;
    }
    ...
    function _getListContent(oCardDefinition, oSapCard) {
        ...
        oContent.data = ContentHelper.getData(oSapCard.data.request.batch);
