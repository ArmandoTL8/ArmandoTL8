sap.ui.define([
    ...
    "sap/m/MessageToast",
    "sap/ovp/cards/Integration/Helpers/CardAction"
], function (
    Card,
    ...
    var getRangeOptionFilter = function (oCardDefinition, aRangeFilters) {
        var oCardController = oCardDefinition.view.getController(),
            oCardNavigationParams =  oCardController && oCardController._getEntityNavigationParameters(),
            ...
            if (oFilterProperty["PropertyValue"] && oFilterProperty["PropertyValue"]["String"]) {
                ...
                if (sMandatoryParam && aParameterKeys.includes(sMandatoryParam)) {
                    ...
                    if (bIsValidSemanticDateRange) {
                        sSemanticDateDescription = Filterhelper.getDateRangeControlValue(sKeyName, oGlobalFilter);
                    }
    ...
    var getFilterDetails = function (oCardDefinition) {
        ...
        var oTargetEntityType = oFilterMetaModel.getODataEntityType(sTargetEntityname);
        ...
        aParams.forEach(function (oParameter) {
            ...
            if (bIsValidSemanticDateRange) {
                ...
                sSemanticDateDescription = Filterhelper.getDateRangeControlValue(oParameter.name, oGlobalFilter);
            }
        ...
        for (var i = 0; i < aCommonFilterProperties.length; i++) {
            ...
            if (aParameterKeys.includes(oFilterProp.name)) {
                ...
                if (bIsValidSemanticDateRange) {
                    ...
                    sSemanticDateDescription = Filterhelper.getDateRangeControlValue(oFilterProp.name, oGlobalFilter);
                }
    ...
    var createManifestFor = function (oCardDefinition) {
        ...
        var oActions = CardActionHelper.getCardActions(oCardDefinition, oManifest["sap.card"]);
