...
sap.ui.define([
    ...
    "sap/ovp/cards/v4/charts/config"
], function (
    each,
    merge,
    OVPLogger,
    ...
    var oLogger = new OVPLogger("OVP.v4.charts.Utils");
    ...
    oUtils.getConfig = function (oChartType) {
        ...
        try {
            ...
            oLogger.error(errorMessages.CARD_ERROR + errorMessages.INVALID_CHARTTYPE + errorMessages.ANNO_REF);
            return {};
        }
