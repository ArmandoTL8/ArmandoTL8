sap.ui.define([
    ...
    var oLogger = new OVPLogger("OVP.v4.linklist.AnnotationHelper");
    /*
                ...
                for (var j = 0; j < oSelectOption.Ranges.length; j++) {
                    ...
                    if (oRange.Sign.$EnumMember) {
                        ...
                        var oFilter = {
                            ...
                            value1: V4AnnotationHelper.getPrimitiveValue(oRange.Low),
                            value2: V4AnnotationHelper.getPrimitiveValue(oRange.High),
                            sign: oRange.Sign.$EnumMember === "com.sap.vocabularies.UI.v1.SelectionRangeSignType/I"
                                    ? "I"
                                    : "E"
                        };
    ...
    function formatItems(iContext, oEntitySet, oHeaderAnnotation) {
        ...
        if (oModel.getProperty("/selectionAnnotationPath")) {
            var selectionAnnotationPath = "@" + oModel.getProperty("/selectionAnnotationPath");
                ...
                if (oModel.getProperty("/listFlavor") === "standard") {
                    ...
                    if (oModel.getProperty("/densityStyle") === "cozy") {
                        ...
                        if (
                            ...
                            typeOfLinklist.indexOf("Description") === -1 &&
                            typeOfLinklist.indexOf("Title") > 0
                        ) {
                            iItemHeight = 48;
                        }
                    } else {
        ...
        if (oSelectionVariant || !!aParameters) {
            if ((oSelectionVariant && oSelectionVariant.Parameters) || !!aParameters) {
                ...
                sEntitySetPath = V4AnnotationHelper.resolveParameterizedEntitySet(
        ...
        var bCheckFilterPreference = V4AnnotationHelper.checkFilterPreference(oModel);
