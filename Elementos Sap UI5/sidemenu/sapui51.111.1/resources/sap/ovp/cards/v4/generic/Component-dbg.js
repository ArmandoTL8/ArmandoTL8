sap.ui.define([
    ...
    return UIComponent.extend("sap.ovp.cards.v4.generic.Component", {
        ...
        metadata: {
            properties: {
                ...
                controllerName: {
                    type: "string",
                    defaultValue: "sap.ovp.cards.v4.generic.Card"
                },
        ...
        setPresentationVariant: function (sPresentationVariantPath, oSettings, oEntityType) {
            ...
            var aVisualizations =
                splitedPresentationVariantPath.length === 1
                    ...
                    : oEntityType[splitedPresentationVariantPath[0]][splitedPresentationVariantPath[1]][
                        splitedPresentationVariantPath[2]
                    ].Visualizations;
            var index;
            /*
        ...
        getPreprocessors: function (pOvplibResourceBundle) {
            ...
            // v4
            if (oModel && oModel.getODataVersion) {
            ...
            var oAdditionalData = {
                ...
                layoutDetail:
                    oCardLayoutData && oCardLayoutData.cardLayout
                        ? oCardLayoutData.cardLayout.containerLayout
                        : "fixed",
            ...
            if (oComponentData.errorReason) {
                ...
                var oParameters = oErrorReason.getParameters
                    ? oErrorReason.getParameters()
                    : oErrorReason.mParameters;
                ...
                if (oParameters && oParameters.response) {
                    ...
                    oCardProperties.sMessageIcon = oParameters.response.sIcon
                        ? oParameters.response.sIcon
                        : sErrorIcon;
                }
            }
            if (oCardLayoutData) {
                ...
                if (oSettings && oSettings.kpiAnnotationPath) {
                    ...
                    if (
                        ...
                        (contentFragment === "sap.ovp.cards.v4.charts.analytical.analyticalChart" ||
                            contentFragment === "sap.ovp.cards.v4.charts.smart.analyticalChart")
                    ) {
                    ...
                    if (oSelectionPresentationVariant) {
                        var sSelectionVariantPath =
                            oSelectionPresentationVariant.SelectionVariant &&
                            oSelectionPresentationVariant.SelectionVariant.Path;
                        if (sSelectionVariantPath) {
                            this.setSelectionVariant(sSelectionVariantPath, oSettings);
                        }
                        var sPresentationVariantPath =
                            oSelectionPresentationVariant.PresentationVariant &&
                            oSelectionPresentationVariant.PresentationVariant.Path;
                        if (sPresentationVariantPath) {
                            this.setPresentationVariant(sPresentationVariantPath, oSettings, oEntityType);
                        }
                    }
            ...
            if (oAdditionalData.template === "sap.ovp.cards.v4.linklist" && !!oSettings.staticContent) {
                for (var i = 0; i < oSettings.staticContent.length; i++) {
                    oSettings.staticContent[i].id = "linkListItem--" + (i + 1);
                }
            } else if (oAdditionalData.template === "sap.ovp.cards.v4.charts.analytical") {
        ...
        _getCacheKeys: function () {
            ...
            //   if (oComponentData.appComponent && !(oComponentData.appComponent instanceof sap.ui.base.ManagedObject)){
            //         return;
            //     }
            ...
            //             }
            //             if (iCacheKey === 0) {
            //                 Log.error("No valid cache key segment last modification date provided by OData annotations");
        ...
        createContent: function () {
            ...
            var fnCombineBatch = function () {
                if (oModel && sModelName) {
                    ...
                    if (
                        oModelViewMap &&
                        sModelName &&
                        oModelViewMap[sModelName] &&
                        oModelViewMap[sModelName][oComponentData.cardId]
                    ) {
            ...
            var oViewConfig = {
                ...
                type: ViewType.XML,
                viewName: "sap.ovp.cards.v4.generic.Card"
            };
            ...
            if (!sLoadingOrErrorState) {
                sIdForCardView =
                    sIdForCardView +
                    (oComponentData.settings.selectedKey ? "_Tab" + oComponentData.settings.selectedKey : "");
            }
