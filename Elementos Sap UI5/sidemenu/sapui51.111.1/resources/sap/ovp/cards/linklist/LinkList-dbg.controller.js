sap.ui.define([
    ...
    var oLogger = new OVPLogger("OVP.linklist.LinkList");
    ...
    return CardController.extend("sap.ovp.cards.linklist.LinkList", {
            ...
            switch (oCardPropertiesModel.getProperty("/listFlavor")) {
                ...
                case "carousel":
                    ...
                    if (oCardPropertiesModel.getProperty("/staticContent")) {
                        ...
                        if (
                            iRows &&
                            !(!oCardPropertiesModel.getProperty("/defaultSpan") && oCardPropertiesModel.getProperty("/cardLayout/autoSpan"))
                        ) {
        ...
        itemOnBeforeRendering: function (oEvent) {
            ...
            switch (oCardPropertiesModel.getProperty("/listFlavor")) {
                case "standard":  
                    ...
                    //Added to fix extra space in linklist card issue
                    if (
                        !oCardPropertiesModel.getProperty("/defaultSpan") &&
        ...
        getSpansWhenNoDefaultSpanMentioned: function () {
            ...
            return Math.ceil(
                (iLinkListItemHeight * Math.min(iNoOfItems, 6) + (iHeaderHeight + LINKLIST_BORDER_TOP + LINKLIST_BORDER_BOTTOM)) /
                iRowHeight
            );
        },
