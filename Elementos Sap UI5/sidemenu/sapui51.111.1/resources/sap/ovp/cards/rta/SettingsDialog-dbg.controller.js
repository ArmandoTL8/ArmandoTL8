sap.ui.define([
    ...
    FilterOperator,
    ChangeReason,
    LinkAnnotationHelper,
    V4CardAnnotationHelper,
    ...
    var oLogger = new OVPLogger("OVP.rta.SettingDialog");
    ...
    return Controller.extend("sap.ovp.cards.rta.SettingsDialog", {
        ...
        onAfterRendering: function () {
            ...
            this._oOriginalCardManifestSettings = merge({}, this._oCardManifestSettings);
            ...
            if (!this._oCardManifestSettings.addNewCard) {
                ...
                setTimeout(
                    function () {
                        ...
                        if (dialogCard && dialogCard.getVisible()) {
        ...
        addView: function (oEvent) {
            ...
            if (!oCardManifestSettings.addNewCard) {
                if (
                    oCardManifestSettings.dataPointAnnotationPath &&
                    oCardManifestSettings.dataPoint &&
            ...
            if (oCardManifestSettings.tabs && oCardManifestSettings.tabs.length) {
                ...
                if (!oCardManifestSettings.addNewCard) {
                    if (
                        oCardManifestSettings.template === "sap.ovp.cards.charts.analytical" ||
                        oCardManifestSettings.template === "sap.ovp.cards.charts.smart.chart"
                    ) {
                        oCardManifestSettings.tabs.push({
                            ...
                            value:
                                this.oOvpResourceBundle &&
                                this.oOvpResourceBundle.getText("OVP_KEYUSER_LABEL_VIEW_NAME") +
                                " " +
                                oCardManifestSettings.newViewCounter
                        });
                    } else {
                    ...
                    oCardManifestSettings.tabs.push({
                        ...
                        value:
                            this.oOvpResourceBundle &&
                            this.oOvpResourceBundle.getText("OVP_KEYUSER_LABEL_VIEW_NAME") + " " + oCardManifestSettings.newViewCounter
                    });
                }
                ...
                oCardManifestSettings.tabs[0].value =
                    this.oOvpResourceBundle && this.oOvpResourceBundle.getText("OVP_KEYUSER_LABEL_VIEW_NAME") + " 1";
                if (!oCardManifestSettings.addNewCard) {
                    if (
                        oCardManifestSettings.template === "sap.ovp.cards.charts.analytical" ||
                        oCardManifestSettings.template === "sap.ovp.cards.charts.smart.chart"
                ...
                oCardManifestSettings.aViews = [
                    ...
                    },
                    {
                        text:
                            ...
                            this.oOvpResourceBundle.getText("OVP_KEYUSER_LABEL_VIEW_NAME") +
                            " 1 (" +
                            this.oOvpResourceBundle.getText("OVP_KEYUSER_LABEL_DEFAULT_VIEW") +
                            ")",
                        key: 1,
        ...
        deleteView: function (oEvent) {
            ...
            if (selectedKey === oCardManifestSettings.defaultViewSelected) {
                oCardManifestSettings.defaultViewSelected = 1;
                oCardManifestSettings.aViews[selectedKey].text =
                    oCardManifestSettings.aViews[selectedKey].text +
                    " (" +
                    this.oOvpResourceBundle.getText("OVP_KEYUSER_LABEL_DEFAULT_VIEW") +
                    ")";
        ...
        resetView: function () {
            ...
            if (!oSelectedView.isLaterAddedView) {
                ...
                if (iSelectedKey) {
                    ...
                    SettingsConstants.tabFields.forEach(
                        function (field) {
                    ...
                    if (!this._oOriginalCardManifestSettings.tabs || !this._oOriginalCardManifestSettings.tabs.length) {
                        oCardManifestSettings.newViewCounter++;
                        oCardManifestSettings.tabs[iSelectedKey - 1].value =
                            this.oOvpResourceBundle &&
                            this.oOvpResourceBundle.getText("OVP_KEYUSER_LABEL_VIEW_NAME") + " " + oCardManifestSettings.newViewCounter;
                    }
                    if (iSelectedKey === oCardManifestSettings.defaultViewSelected) {
                        oCardManifestSettings.aViews[iSelectedKey].text =
                            oCardManifestSettings.tabs[iSelectedKey - 1].value +
                            " (" +
                            this.oOvpResourceBundle.getText("OVP_KEYUSER_LABEL_DEFAULT_VIEW") +
                            ")";
                    ...
                    SettingsConstants.mainFields.forEach(
                        function (field) {
                            /* None of the field is of type object hence direct copy is fine.*/
                            oCardManifestSettings[field] = this._oOriginalCardManifestSettings[field];
                        }.bind(this)
                    ...
                    if (kpiStateOfCurrentCard !== kpiStateOfOriginalCard) {
                        if (kpiStateOfOriginalCard) {
                            ...
                            oCardManifestSettings.dataPointAnnotationPath =
                                oCardManifestSettings.tabs[iDefaultViewSelected].dataPointAnnotationPath;
                        } else {
                            oCardManifestSettings.tabs.forEach(function (tab) {
                ...
                if (!oCardManifestSettings.addNewCard) {
                    ...
                    if (dialogCard.getVisible()) {
                        ...
                        if (!!oCardManifestSettings.kpiAnnotationPath) {
                            this.setAnnotationPathInModel(
                                oCardManifestSettings,
                                "sapOvpSettingsKPIAnnotation",
                                oCardManifestSettings.kpiAnnotationPath
                            );
                        }
                        if (!!oCardManifestSettings.selectionPresentationAnnotationPath) {
                            this.setAnnotationPathInModel(
                                oCardManifestSettings,
                                "sapOvpSettingsFilterAndPresentedBy",
                                oCardManifestSettings.selectionPresentationAnnotationPath
                            );
                        }
                        this.getView().getModel("visibility").refresh();
                        this.getView().getModel().refresh();
                    ...
                    settingsUtils.setVisibilityForFormElements(oCardManifestSettings);
                    this.getView()
                        .byId("sapOVPEntitySetList")
                        .setValue(oCardManifestSettings.tabs[selectedKey - 1].entitySet);
                    this.getView().getModel().refresh();
                    this.getView().getModel("visibility").refresh();
                }
            }
        ...
        resetSupportingObjectsOnEntitySetChange: function (oCardManifestSettings, iDefaultViewSelected) {
            ...
            oCardManifestSettings.aViews[iDefaultViewSelected].text +=
                " (" + this.oOvpResourceBundle.getText("OVP_KEYUSER_LABEL_DEFAULT_VIEW") + ")";
        ...
        createValueHelpDialogForInternalUrl: function (oEvent) {
            ...
            var oBaseEvent = new BaseEvent();
            this._oEvent = Object.assign(oBaseEvent, oEvent);
            ...
            // Links Dialog
            var oLinksDialogContent = new XMLView("linksDialogContent", {
            ...
            oLinksDialogContent.loaded().then(
                function (oView) {
        ...
        onChangeVisualPress: function (oEvent) {
            ...
            // Icons Dialog
            var oIconsDialogContent = new XMLView("iconsDialogContent", {
            ...
            oIconsDialogContent.loaded().then(
                function (oView) {
        ...
        browserHeightChange: function (iBrowser) {
            ...
            if (oDialog && oDialogContent && sScrollContainerName) {
                var oDomRef = oDialog.getDomRef(),
                     ...
                     */
                    iDialogExpectedHeight = iBrowser
                        ? (iBrowser.height * 93) / 100
                        : settingsUtils.dialogBox.getDomRef().getBoundingClientRect().height,
        ...
        onPressDelete: function (oEvent) {
            var oBaseEvent = new BaseEvent();
            this._oEvent = Object.assign(oBaseEvent, oEvent);
            MessageBox.confirm(this.oOvpResourceBundle.getText("OVP_KEYUSER_MESSAGE_BOX_INFORMATION_MESSAGE_INFO"), {
        ...
        onResetButton: function () {
            this._oCardManifestSettings = merge({}, this._oOriginalCardManifestSettings);
        ...
        validateComboBox: function (oCardManifestSettings, sPropertyType, bKPICheckboxFlag) {
            ...
            if (
                (sPropertyType === "KPICheckBox" && bKPICheckboxFlag && oCardManifestSettings.entitySet) ||
                ...
                if (oCardManifestSettings.valueSelectionInfo === "") {
                    ...
                    this.handleValueStateofComboBox(
                        sErrorText,
                        OVPUtils.Annotations.valueSelectionInfo,
                        "sapOvpValueSelectionInfo",
                        true
                    );
                } else {
                ...
                this.handleValueStateofComboBox(sErrorText, OVPUtils.Annotations.title, "sapOvpCardTitle", true);
                if (
                    oCardManifestSettings.template === "sap.ovp.cards.linklist" ||
                    oCardManifestSettings.template === "sap.ovp.cards.v4.linklist"
                ) {
                ...
                if (sPropertyType === "title") {
                    this.onComboBoxSelection(
                        oCardManifestSettings,
                        sPropertyType,
                        "OVP_KEYUSER_INPUT_ERROR",
                        OVPUtils.Annotations.title,
                        "sapOvpCardTitle"
                    );
                }
                if (sPropertyType === "subTitle") {
                    this.onComboBoxSelection(
                        oCardManifestSettings,
                        sPropertyType,
                        "OVP_KEYUSER_INPUT_ERROR_VALUE_STATE_SUBTITLE",
                        OVPUtils.Annotations.subTitle,
                        "sapOvpCardSubTitle"
                    );
                }
                if (sPropertyType === "valueSelectionInfo") {
                    this.onComboBoxSelection(
                        oCardManifestSettings,
                        sPropertyType,
                        "OVP_KEYUSER_INPUT_ERROR_VALUE_STATE_SELECTIONVALUEINFO",
                        OVPUtils.Annotations.valueSelectionInfo,
                        "sapOvpValueSelectionInfo"
                    );
                }
                if (sPropertyType === "dataPointAnnotationPath") {
                    this.onComboBoxSelection(
                        oCardManifestSettings,
                        sPropertyType,
                        "OVP_KEYUSER_INPUT_ERROR_VALUE_STATE_DATAPOINT",
                        OVPUtils.Annotations.dataPoint,
                        "sapOvpDataPoint"
                    );
                }
                if (sPropertyType === "listFlavor") {
                    this.onComboBoxSelection(
                        oCardManifestSettings,
                        sPropertyType,
                        "OVP_KEYUSER_LISTFLAVOR_ERROR",
                        OVPUtils.Annotations.listFlavor,
                        "sapOVPLinkListFlavor"
                    );
                }
            }
        },
        ...
        _fCardWithoutRefresh: function (oEvent, updatedElementProps) {
            ...
            if (
                updatedElementProps.formElementId === "sapOvpSettingsLineItemTitle" ||
            ...
            switch (updatedElementProps.formElementId) {
                ...
                case "sapOvpSettingsSubTitle":
                    ...
                    oCardController._setSubTitleWithUnitOfMeasure(undefined, true);
                    break;
                ...
                case "sapOvpDefaultViewSwitch":
                    if (oEvent.getSource().getState()) {
                        ...
                        oCardManifestSettings.aViews[defaultSelectedKey].text =
                            oCardManifestSettings.tabs[defaultSelectedKey - 1].value;
                        oCardManifestSettings.aViews[iSelectedKey].text +=
                            " (" + this.oOvpResourceBundle.getText("OVP_KEYUSER_LABEL_DEFAULT_VIEW") + ")";
                        oManifestModel.refresh();
                ...
                case "sapOvpSettingsIdentification":
                    if (isViewSwitchEnabled) {
                        oCardManifestSettings.tabs[iSelectedKey - 1][updatedElementProps.updateProperty] =
                            oCardManifestSettings[updatedElementProps.updateProperty];
                    }
                    break;
        ...
        _fCardWithRefresh: function (oEvent, updateProperty) {
            var sPrevDataPointAnnotationPath,
                defaultViewSelected,
                oView,
                oVisibilityModel,
                oVisibilityData,
                ...
                card = !oComponentContainer.getComponentInstance()
                    ? undefined
                    : oComponentContainer.getComponentInstance().getComponentData(),
                ...
                case "subTitleSwitch":
                    ...
                    if (oEvent.getSource().getState()) {
                        if (isViewSwitchEnabled) {
                            ...
                            oCardManifestSettings.dynamicSubtitleAnnotationPath =
                                oCardManifestSettings.tabs[defaultViewSelected - 1].dynamicSubtitleAnnotationPath;
                        } else {
                        ...
                        if (card.template !== "sap.ovp.cards.linklist" && card.template !== "sap.ovp.cards.v4.linklist") {
                            oSettingDialog
                                .byId("sapOvpSettingsDynamicSubTitle")
                                .setSelectedKey(oCardManifestSettings.dynamicSubtitleAnnotationPath);
                        }
                    } else {
                        if (isViewSwitchEnabled) {
                            oCardManifestSettings.tabs.forEach(function (tab) {
                    ...
                    oVisibilityModel.setProperty(
                        ...
                        !!oCardManifestSettings["dynamicSubTitle"] &&
                        !!oCardManifestSettings["dynamicSubTitle"].length
                    );
                    oVisibilityModel.refresh(true);
                    break;
                case "kpiHeader":
                    ...
                    if (isViewSwitchEnabled) {
                        ...
                        oCardManifestSettings.dataPointAnnotationPath =
                            oCardManifestSettings.tabs[defaultViewSelected - 1].dataPointAnnotationPath;
                    } else {
            ...
            if (settingsUtils.bNewKPICardFlag) {
                ...
                modelName =
                    CommonUtils._getLayerNamespace() + ".kpi_card_model_" + settingsUtils.getTrimmedDataURIName(oSelectedKPI.ODataURI);
        ...
        setVariant: function (oCardManifestSettings, SelectedKey) {
            ...
            if (SelectedKey.indexOf(".KPI") !== -1) {
                presentationVariant =
                    ...
                    SelectedEntity.Detail.DefaultPresentationVariant &&
                    SelectedEntity.Detail.DefaultPresentationVariant.Path;
            ...
            var aVisualizations =
                oCardManifestSettings.entityType[oCardManifestSettings.presentationAnnotationPath] &&
                oCardManifestSettings.entityType[oCardManifestSettings.presentationAnnotationPath].Visualizations;
        ...
        getListItems: function () {
            ...
            var oModel = card.model.getMetaModel();
            var bIsOdataV4 = CommonUtils.isODataV4(card.model);
            var lineItemBindingPath = bIsOdataV4
                ? "/" + oCardManifestSettings.entityType.$Type + "/@" + oCardManifestSettings.annotationPath
                : oCardManifestSettings.entityType.$path + "/" + oCardManifestSettings.annotationPath;
            var iContext = oModel.getContext(oModel.resolve(lineItemBindingPath, this.oView.getBindingContext()));
            ...
            if (oCardManifestSettings.listType && oCardManifestSettings.listType.toLowerCase() === "extended") {
                ...
                oCardManifestSettings.contentFragment === "sap.ovp.cards.table.Table" ||
                oCardManifestSettings.contentFragment === "sap.ovp.cards.table.v4.Table"
            ) {
            ...
            oCardManifestSettings.lineItem.forEach(function (lineItem) {
                var aDataPointsObjects = bIsOdataV4
                    ? V4CardAnnotationHelper.getSortedDataPoints(iContext, lineItem.fields)
                    : CardAnnotationHelper.getSortedDataPoints(iContext, lineItem.fields);

                var aDataFieldsObjects = bIsOdataV4
                    ? V4CardAnnotationHelper.getSortedDataFields(iContext, lineItem.fields)
                    : CardAnnotationHelper.getSortedDataFields(iContext, lineItem.fields);
                ...
                aDataPointsObjects.forEach(function (fields) {
                    if (fields.Title) {
                        var title = bIsOdataV4 ? fields.Title : fields.Title.String;
                        dataPoints.push(settingsUtils.checkForEmptyString(title, ""));
                    } else {
                ...
                aDataFieldsObjects.forEach(function (fields) {
                    if (fields.Label) {
                        var label = bIsOdataV4 ? fields.Label : fields.Label.String;
                ...
                var noOfDataPointsUsed = Math.min(dataPoints.length, maxDataPoints),
                    ...
                    visibleField = dataFields
                        .slice(0, maxDataFields - noOfDataPointsOccupyingDataFieldsSpace)
        ...
        onSeePress: function () {
            ...
            oRowsModel.setSizeLimit(this._oCardManifestSettings.KPIData.length);
            oRowsModel.setProperty("/densityStyle", this.getDensityStyle());
            oRowsModel.setProperty("/NoOfKPIItem", oRowsModel.getProperty("/KPIItem").length);
            var oKPIItemDialogContent = new XMLView("KPIItemDialogContent", {
            ...
            oKPIItemDialogContent.loaded().then(
                function (oView) {
        ...
        openLineItemValueHelpDialog: function (oEvent) {
            ...
            // LineItem Dialog
            var oLineItemDialogContent = new XMLView("lineItemDialogContent", {
            ...
            oLineItemDialogContent.loaded().then(
                function (oView) {
                    ...
                    oView.getController().updateLineItemPath = function (oValue) {
                        ...
                        if (oCardManifestSettings.tabs && oCardManifestSettings.tabs.length) {
                            oCardManifestSettings.tabs[iSelectedKey - 1].annotationPath = oCardManifestSettings.annotationPath;
                        }
        ...
        setMandatoryFieldState: function (bValue, oVisibilityModel) {
            ...
            var oVisibilityModelData = oVisibilityModel.getData(),
                bSetAnnotationCardProperties = false;
        ...
        onDatasourceComboboxChanged: function (oEvent) {
            ...
            if (!settingsUtils.newDataSource) {
                ...
                var oDataSourceSelected = this._oCardManifestSettings.datasources.filter(
                    function (oDataSource) {
                        return oDataSource.Title === this._oCardManifestSettings.model;
                    }.bind(this)
                );
                /* eslint-disable */
                getMetaModelForNewDataSource(oDataSourceSelected, settingsUtils.sApplicationId).then(
                    function (oMetaModel) {
                        /* eslint-disable */
                        if (oMetaModel) {
        ...
        onParameterDelete: function (oEvent) {
            ...
            var keyToBeDeleted =
                oEvent.getSource().getBindingContext().getObject() && oEvent.getSource().getBindingContext().getObject()["key"];
        ...
        onActionDelete: function (oEvent) {
            ...
            var keyToBeDeleted =
                oEvent.getSource().getBindingContext().getObject() && oEvent.getSource().getBindingContext().getObject()["text"];
            ...
            if (
                !deepEqual(
                    this._oCardManifestSettings.objectStreamCardsSettings,
                    this._oOriginalCardManifestSettings.objectStreamCardsSettings
                )
            ) {
                this.setEnablePropertyForResetAndSaveButton(true);
            }
                    ...
                    switch (sFormElement) {
                        ...
                        case "identificationAnnotationPath":
                            if (!isViewSwitchEnabled) {
                                ...
                                this._oCardManifestSettings.tabs[iSelectedKey - 1]["identificationAnnotationPath"] =
                        ...
                        case "selectionPresentationAnnotationPath":
                            if (!isViewSwitchEnabled) {
                                ...
                                this._oCardManifestSettings.tabs[iSelectedKey - 1]["selectionPresentationAnnotationPath"] =
                                    oEvent.getParameter("value");
                            }
                            break;
                        case "selectionAnnotationPath":
                            if (!isViewSwitchEnabled) {
                                ...
                                this._oCardManifestSettings.tabs[iSelectedKey - 1]["selectionAnnotationPath"] =
                                    oEvent.getParameter("value");
                            }
                            break;
                        case "presentationAnnotationPath":
                            if (!isViewSwitchEnabled) {
                                ...
                                this._oCardManifestSettings.tabs[iSelectedKey - 1]["presentationAnnotationPath"] =
                                    oEvent.getParameter("value");
                            }
                            break;
                        case "annotationPath":
                        ...
                        case "KPICheckBox":
                            ...
                            this.validateComboBox(
                                this._oCardManifestSettings,
                                "KPICheckBox",
                                this._oCardManifestSettings.addKPIHeaderCheckBox
                            );
                            break;
                        case "dataPointAnnotationPath":
                            if (!isViewSwitchEnabled) {
                                ...
                                this._oCardManifestSettings.tabs[iSelectedKey - 1]["dataPointAnnotationPath"] =
                                    oEvent.getParameter("value");
                            }
                        ...
                        case "newDatasSource":
                            if (oEvent.mParameters.selected) {
                                ...
                                this.getView().setBusy(true);
                                /* eslint-disable */
                                getNewDataSources(settingsUtils.sApplicationId).then(
                                    function (oDataSourceCollection) {
                                        /* eslint-disable */
        ...
        resetPropertiesVisibility: function (ElementId, oCardProperies) {
            ...
            if (ElementId.indexOf("sapOVPExistingDataSource") !== -1 || ElementId.indexOf("sapOVPNewDataSource") !== -1) {
                this._updateManifestProperties.forEach(function (oProperty) {
                    if (
                        !oProperty.formElementId.includes("sapOVPExistingDataSource") &&
                        !oProperty.formElementId.includes("sapOVPNewDataSource")
                    ) {
                ...
                this._updateManifestProperties.forEach(function (oProperty) {
                    if (
                        !oProperty.formElementId.includes("sapOVPExistingDataSource") &&
                        !oProperty.formElementId.includes("sapOVPNewDataSource") &&
                        !ElementId.includes(oProperty.formElementId)
                    ) {
                        if (oProperty.formElementId.includes("sapOVPAddODataSelect")) {
                            oCardProperies[oProperty.formElement] = false;
                        } else {
            ...
            } else if (ElementId.indexOf("sapOVPCardType") !== -1) {
                //Reset all the fields except Data source and card type dropdown
                this._updateManifestProperties.forEach(function (oProperty) {
                ...
                // this.resetTextFields(oCardProperies);
            } else if (ElementId.indexOf("sapOVPEntitySetList") !== -1) {
                //Reset all the fields except Data source, card type and entity set dropdown
                var showViewSwitch = this.getView().getModel("visibility").getData().showViewSwitch;
                this._updateManifestProperties.forEach(function (oProperty) {
                    if (
                        !(
                            oProperty.formElementId.includes("sapOVPDataSource") ||
                            oProperty.formElementId.includes("sapOVPCardType") ||
