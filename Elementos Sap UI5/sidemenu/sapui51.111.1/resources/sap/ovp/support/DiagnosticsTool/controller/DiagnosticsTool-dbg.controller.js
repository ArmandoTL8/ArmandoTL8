sap.ui.define([
    ...
    var oLogger = new OVPLogger("OVP.controller.DiagnosticsTool");
    /**
    ...
    function fnOnCopyDataPlain() {
        ...
        var sContent =
            "*************+Extracted by SAP Fiori Elements Diagnostics Plugin [FEDiagnosticOVP]+*************" +
            sNewLine;
        ...
        sContent +=
            sPrefix +
            "Steps to recreate the issue: <maybe also provide master data, pictures or video…>" +
            sNewLine;
        ...
        try {
            ...
            if (bSuccess) {
                ...
                MessageBox.error(
                    "Could not copy data to your clipboard! You can copy it manually from here: " +
                    sNewLine +
                    sNewLine +
                    sContent,
                    {
    ...
    function fnShowDataRefreshed() {
        ...
        if (window.fioriElementsPluginID) {
            var $View = document.getElementById(window.fioriElementsPluginID);
