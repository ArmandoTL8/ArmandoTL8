sap.ui.define(["sap/m/p13n/Popup",
	...
	AddCardsHelper.showColumnsForCardGeneration = function (oCardDefinition, oButton, oTemplateUtils) {
		return new Promise(function (fnResolve, fnReject) {
			...
			fnCreateP13nDialogBeforeCardGeneration(aColumns, oButton, oCardDefinition, oTemplateUtils, fnResolve);
		});
	};
 ...
 */
	...
	function fnCreateP13nDialogBeforeCardGeneration(aColumns, oButton, oCardDefinition, oTemplateUtils, fnResolve) {
		...
		oTemplateUtils.oServices.oApplication.attachControlToParent(oPopup, oCardDefinition.view);
		oPopup.open(oButton);
	}
