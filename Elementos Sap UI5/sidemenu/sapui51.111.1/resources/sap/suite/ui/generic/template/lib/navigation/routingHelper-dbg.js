	...
	var oStandardBehaviour = { 
		...
		var oCrossAppNavService = (sap && sap.ushell && sap.ushell.Container) ? sap.ushell.Container.getService("CrossApplicationNavigation") : (function(){
			...
			return {
				...
				isInitialNavigationAsync: function(){
		...
		// 1. Attach the standard model with a name specific to this TreeNode to the AppComponent. The absolute binding for this named model will always be adapted to the current binding of subpages which are visible.
