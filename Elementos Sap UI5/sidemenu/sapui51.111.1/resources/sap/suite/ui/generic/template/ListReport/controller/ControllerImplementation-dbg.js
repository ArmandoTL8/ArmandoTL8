...
sap.ui.define([
	...
	WorklistHandler, ShareUtils, controlHelper, FeLogger, ObjectPath, StableIdHelper, deepExtend, CreateWithDialogHandler, 
	MultiEditHandler, SelectionVariant, AddCardsHelper, filterSettingsPreparationHelper) {
	"use strict";
			...
			return {
				...
				handlers: {
					...
					onAddCardsToRepository: function(oEvent){
						...
						AddCardsHelper.showColumnsForCardGeneration(oCardDefinition, oEvent.getSource(), oTemplateUtils).then(function (oCardManifest){
