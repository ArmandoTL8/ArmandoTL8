...
`		@param {object} App data
		...
		/**
		 * State of the page (oState) could fall under one of the following categories:
		 * 1) State is not present at all: It would be considered as a startup case and NavigationHandler.parseNavigation would be called.
