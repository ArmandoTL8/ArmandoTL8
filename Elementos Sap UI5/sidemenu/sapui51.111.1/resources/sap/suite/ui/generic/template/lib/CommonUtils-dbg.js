sap.ui.define(["sap/ui/base/Object",
...
], function(BaseObject, Event, ControllerExtension, Context, Filter, MessageBox, SelectionVariant, controlHelper, metadataAnalyser,
	...
	function getMethods(oController, oServices, oComponentUtils) {
		...
		function fnSetEnabledToolbarButtons (oSubControl) {
			...
			var oControl = getOwnerControl(oSubControl, true);  // look for parent table or chart
