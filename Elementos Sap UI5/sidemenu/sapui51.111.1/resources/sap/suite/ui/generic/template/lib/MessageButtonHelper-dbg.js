sap.ui.define([
	...
	function getMethods(oTemplateUtils, oHost, bIsODataBased) {
		...
		function isPositionable(sMsgId, aControlIds, bIsPopoverOpen) {
			return !!(bIsPopoverOpen && aControlIds && oTemplateUtils.oCommonUtils.getPositionableControlId(aControlIds));
		}
		...
		// will also be called when the message popover is closed. Note that it is expected that it only performs a trivial action in this case,
