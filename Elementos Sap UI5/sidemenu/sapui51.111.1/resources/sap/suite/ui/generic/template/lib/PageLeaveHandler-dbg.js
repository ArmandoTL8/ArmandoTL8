sap.ui.define(["sap/ui/base/Object", 
	...
	function getMethods(oTemplateContract) {
		...
		*/
		...
		function fnSaveDraft(oTemplateContract, sMode) {
			...
			var oDonePromise = oActivationPromise.then(function (oResponse) {
				...
				var oActiveContext = oResponse.context;
				var oBackNavigationPromise = (sMode === "LeaveApp" && oTemplateContract.oApplicationProxy.navigateAfterActivation(oActiveContext, true)) || Promise.resolve();
				return oBackNavigationPromise.then(function (oBackNavigationOption) {
			...
			oTemplateContract.oBusyHelper.setBusy(oDonePromise);
			var oEvent = {
