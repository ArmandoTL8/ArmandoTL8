	...
	GanttPopoverExtension.prototype._getPopoverData = function(oEvent, bTimePopover) {
		...
		if (bTimePopover) {
			...
			if (oCurrentTime) {
				...
				oPopoverData.startNewDate = Utility.getLowerCaseLabel(oFormater.format(oCurrentTime.time));
				oPopoverData.endNewDate = Utility.getLowerCaseLabel(oFormater.format(oCurrentTime.endTime));
			}
		}
		return oPopoverData;
	};
