sap.ui.define([
    ...
    var FindAndSelectUtils = {
        ...
        scrollToShape: function(ofindAndSelectData, oGantt) {
            ...
            function _getShapeFromShapeId (oShape, oGantt, ofindAndSelectData, sShapeId) {
                ...
                if (oShape.isPseudoShape) {
                    ...
                    for (var i = 0; i < aShapeIDs.length && !that._oFoundShape && bIsExpandRequired; i++) {
        ...
        triggerSearchEvent: function(sSearchValue, aGanttCharts, bSidePanel, oToolBar, oSearchSidePanel) {
            ...
            var bEnableAutoSelectOnFind = oContainer.getEnableAutoSelectOnFind();
            ...
            var createSearchResults = function() {
                ...
                if (bSidePanel && bEnableAutoSelectOnFind) {    // select list item and set focus
                ...
                if (!oContainer._bPreventShapeScroll && bEnableAutoSelectOnFind) {    // clear selected/highlighted shapes
                    this.updateShapeSelectionANDHighlight(aGanttCharts, this.previousGanttID);
                }
                ...
                if (firstRowInfo) {
                    ...
                    if (!oContainer._bPreventShapeScroll && bEnableAutoSelectOnFind) {    // scroll to found shape
            ...
            if (!bSidePanel || !bEnableAutoSelectOnFind) {    // set focus on navigation buttons
                setTimeout(function() {
