...
sap.ui.define([
		...
		metadata: {
			...
			properties: {
				...
				*/
				 ...
				 * @private
				 */
				showSearchSidePanel: { type: "boolean", defaultValue: false },
	...
	GanttChartContainer.prototype._addChangesToControlPersonalizationWriteAPI = function(oEvent, aChanges) {
		var isVariantEnabled = this.getEnableVariantManagement() || this.getProperty("_enableRTA");
	 ...
	 * @experimental since 1.106
	 */
	GanttChartContainer.prototype.updateSearch = function() {
		this._bPreventShapeScroll = true;
		if (this.getShowSearchSidePanel()) {
			this.getSearchSidePanel()._oSearchSidePanel.getItems()[1].getContent()[0].fireSearch();
		} else if (this.getToolbar() && this.getToolbar()._searchFlexBox && this.getToolbar()._searchFlexBox.getItems()[0]) {
			this.getToolbar()._searchFlexBox.getItems()[0].fireSearch();
		}
	};
