...
sap.ui.define([
	...
	GanttPointerExtension.prototype.customBar = function (oConatiner,val,timeValue) {
		...
		oConatiner.dateTimeText.setText(val ? Utility.getLowerCaseLabel(Utility.getFormattedDate(oDateFormat, timeValue) + " " +  Utility.getFormattedDate(oTimeFormat, timeValue)) : _oEmptyText.getText());
    };
